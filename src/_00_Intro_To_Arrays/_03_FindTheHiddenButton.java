...
public class _03_FindTheHiddenButton implements ActionListener{
    ...
    public void start() {
        ...
        String size = JOptionPane.showInputDialog("Enter a positive number:");
        int sizeInt = Integer.parseInt(size);
        // 4. Initialize the array of JButtons to be the size of the int
        //    created in step 3
        buttons = new JButton[sizeInt];
        ...
        int hiddenButton = ran.nextInt(sizeInt);
        theHiddenButton = buttons[hiddenButton];
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(buttonClicked == theHiddenButton) {
